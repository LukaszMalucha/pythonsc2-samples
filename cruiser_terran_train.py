...
####################################################################### GAME METHODS ##########################################################################
    ...
    async def build_supplydepot(self):
        ...
        if self.supply_left < 14 and not self.already_pending(SUPPLYDEPOT):
...
## MILITARY BUILDINGS
    ...
    async def build_factory(self):
        ...
        if self.units(BARRACKS).exists:
            if self.units(FACTORY).amount < 2 and not self.already_pending(FACTORY):
    ...
    async def build_fusioncore(self):
        ...
        if self.units(STARPORT).exists: 
            if self.units(FUSIONCORE).amount < 2:
